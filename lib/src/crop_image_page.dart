...
class _ImageCompressCropPageState extends State<ImageCompressCropPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: widget.uint8list == null && widget.imageFile == null
          ? Padding(
  ...
  Widget cropWidget({required Uint8List image}) => Crop(
        image: image,
        controller: controller,
        onCropped: (image) async {
          if (widget.imageFile != null && widget.uint8list == null) {
            await widget.onTap(await convertImageFile(
  ...
  Widget processingWidget() => (widget.waitingWidget ??
      Container(
